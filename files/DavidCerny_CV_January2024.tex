...
2018--2024 & Ph.D. candidate in Geophysical Sciences; University of Chicago \\[0.1cm]
...
2024 & Pol D, Baiano MA, \textbf{\v{C}ern\'{y} D}, Novas FE, Pittman M. A new abelisaurid dinosaur from the end Cretaceous of Patagonia and evolutionary rates among the Ceratosauria. \textit{Cladistics}.
\end{tabularx}
\noindent \begin{tabularx}{\textwidth}{>{\raggedleft\arraybackslash}p{2.2cm} X}
...
Summer 2023, & PHSC 13410: Global Warming: Understanding the Forecast. Instructor of record. \\
Spring 2023, & (3$\times$) \\
