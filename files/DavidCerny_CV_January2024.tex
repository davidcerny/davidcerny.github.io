...
In review & Pol D, Baiano MA, \textbf{\v{C}ern\'{y} D}, Novas FE, Pittman M. A new abelisaurid dinosaur from the end Cretaceous of Patagonia and evolutionary rates among the Ceratosauria. \textit{Cladistics}.
\end{tabularx}
\noindent \begin{tabularx}{\textwidth}{>{\raggedleft\arraybackslash}p{2.2cm} X}
